    ...
    return (
        ...
        <section className="page-header page-header-text-light py-0 mb-0">
          <div className="hero-wrap py-2 py-md-3 py-lg-5">
            ...
            <div className="hero-bg" style={{backgroundImage: 'url("./images/bg/image-3.jpg")'}} />
            <div className="hero-content py-3 py-lg-5 my-3 my-md-5">
              <div className="container">
                <div className="row align-items-center text-center">
                  ...
                  <div className="col-12">
                    <h1 className="text-9">Page Header</h1>
                    <p className="lead mb-0">with Custom Background</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-sm-6 col-md-3">
                  <div className="featured-box text-center">
                    <div className="featured-box-icon text-light mb-2"> <i className="fas fa-globe" /> </div>
                ...
                <div className="col-sm-6 col-md-3">
                  <div className="featured-box text-center">
                    <div className="featured-box-icon text-light mb-2"> <i className="fas fa-dollar-sign" /> </div>
                ...
                <div className="col-sm-6 col-md-3 mt-4 mt-md-0">
                  <div className="featured-box text-center">
                    <div className="featured-box-icon text-light mb-2"> <i className="fas fa-users" /> </div>
                ...
                <div className="col-sm-6 col-md-3 mt-4 mt-md-0">
                  <div className="featured-box text-center">
                    <div className="featured-box-icon text-light mb-2"> <i className="far fa-life-ring" /> </div>
