                ...
                <div className="container">
                    ...
                    ============================================= */}
                            <div className="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
                                ...
                                <p className="text-center text-3 mb-4">You've successfully <span className="text-4 font-weight-500">$1000</span> Deposit Money, See transaction details under <a href="#">Activity</a>.</p>
                                <button className="btn btn-primary btn-block">Deposit Money Again</button>
...
export default DepositeMoneySuccess
