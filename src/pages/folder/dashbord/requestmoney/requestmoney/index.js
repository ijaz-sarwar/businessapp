        ...
        <div>
            ...
            <div id="content" className="py-4">
                <div className="container">
                    ...
                    <p className="text-4 text-center mb-4">Request your payment on anytime, anywhere in the world.</p>
                    <div className="row">
                        <div className="col-md-8 col-lg-6 col-xl-5 mx-auto">
                            <div className="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
                                <h3 className="text-5 font-weight-400 mb-3">Payer Details</h3>
                                {/* Request Money Form
                      ============================================= */}
                                <form id="form-send-money" method="post">
                                    <div className="form-group">
                                        <label htmlFor="payerName">Name</label>
                                        <input type="text" defaultValue className="form-control" data-bv-field="payerName" id="payerName" required placeholder="Enter Name" />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="text" className="form-control" data-bv-field="amount" id="amount" defaultValue="1,000.00" placeholder />
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="paymentDue">Payment due by</label>
                                        <div className="position-relative">
                                            <input id="paymentDue" defaultValue type="text" className="form-control" required placeholder="Payment Due Date" />
